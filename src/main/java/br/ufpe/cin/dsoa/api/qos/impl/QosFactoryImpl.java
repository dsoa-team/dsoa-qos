...
public class QosFactoryImpl extends EFactoryImpl implements QosFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case QosPackage.ATTRIBUTE: return createAttribute();
			case QosPackage.ATTRIBUTE_CATEGORY: return createAttributeCategory();
			default:
	...
	public AttributeCategory createAttributeCategory() {
		AttributeCategoryImpl attributeCategory = new AttributeCategoryImpl();
